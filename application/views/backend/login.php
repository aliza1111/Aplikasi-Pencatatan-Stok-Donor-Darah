                ...
                <div class="col-12 col-sm-8 col-md-6 col-lg-5 col-xl-4">
                    <div class="bg-secondary rounded p-4 p-sm-5 my-4 mx-3">
                        <div class="d-flex align-items-center justify-content-between mb-3">
                            <a href="#" class="">
                            <i><img src="<?php echo base_url('assets/img/logo.png'); ?>" alt="Pandas" width="70"><h3 class="text-primary"></i>PandasTeam</h3>
                            </a>
                        </div>
                        <form method="post" action="<?php echo site_url('auth/login') ?>">
                            <div class="form-floating mb-3">
                                <input type="kd_admin" class="form-control" id="floatingInput"
                                    placeholder="Masukan kode" name="kd_admin" required>
                                <label for="floatingInput">Kode Admin</label>
                            </div>
                            <div class="form-floating mb-4">
                                <input type="password" class="form-control" id="floatingPassword"
                                    placeholder="Password" name="pswd_admin" required>
