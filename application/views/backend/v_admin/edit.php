    ...
    <div class="bg-secondary rounded h-100 p-4">
        ...
        <form action="<?php echo site_url('Admin/update/' . $edit['kd_admin']) ?>" method="post">
            <div class="mb-3">
                ...
                <input type="text" class="form-control" name="kd_admin" disabled value="<?php echo $edit['kd_admin'] ?>">
                <input type="hidden" name="kd_admin" value="<?php echo $edit['kd_admin'] ?>">
            </div>
            <div class="mb-3">
                <label class="form-label">Nama Admin</label>
                <input type="text" class="form-control" name="nama_admin" value="<?php echo $edit['nama_admin'] ?>">
            </div>
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" name="password" value="<?php echo $edit['password'] ?>">
            </div>
            <div class="d-flex">
                <button type="submit" name="button" class="btn btn-success me-2">Perbarui</button>
                <a href="<?php echo site_url('Admin') ?>" class="btn btn-primary">Batal</a>
            </div>
        </form>
    </div>
</div>
