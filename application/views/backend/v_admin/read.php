        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-secondary navbar-dark">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <a href="<?php echo site_url('Admin') ?>" class="nav-item nav-link active"><i class="fa fa-chart-bar me-2"></i>Kelola Admin</a>
            ...
            <div class="container-fluid pt-4 px-4">
                <div class="bg-secondary text-center rounded p-4">
                    ...
                    <div class="d-flex align-items-center justify-content-between mb-4">
                        ...
                        <a href="<?php echo site_url('Admin/export') ?>">
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="<?php echo site_url('Admin/edit/' . $row['kd_admin']) ?>" title="tombol utk merubah data">Ubah</a> |
                                            <!--memanggil aksi delete-->
                                            <a href="<?php echo site_url('Admin/delete/' . $row['kd_admin']) ?>" onclick="javascript: return confirm('Yakin Mau dihapus <?php echo $row['nama_admin']; ?>')">Hapus</a>
                                        </td>
                                    </tr>
                                <?php
                                    $no++;
