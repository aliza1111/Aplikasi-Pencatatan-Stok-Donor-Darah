...
<head>
    <meta charset="utf-8">
    <title>Tambah Detail Stok Darah</title>
        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-secondary navbar-dark">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <a href="<?php echo site_url('Stok') ?>" class="nav-item nav-link active"><i class="fa fa-laptop me-2"></i>Stok Darah</a>
        ...
        <div class="content">
            ...
            <div class="container-fluid pt-4 px-4">
                <div class="bg-secondary rounded h-100 p-4">
                    <h6 class="mb-4">Tambah Detail Stok Darah</h6>
                    <form class="" action="<?php echo site_url('Detail/save') ?>" method="post">
                        <div class="mb-3">
                        ...
                        <a href="<?php echo site_url('Detail') ?>"><button type="button" name="button" class="btn btn-primary">Batal</button></a>
                    </form>
                </div>
            </div>
            <!-- Recent Sales End -->
