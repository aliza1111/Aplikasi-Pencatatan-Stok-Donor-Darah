        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-secondary navbar-dark">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <a href="<?php echo site_url('Detail') ?>" class="nav-item nav-link active"><i
                ...
                <div class="bg-secondary rounded h-100 p-4">
                    ...
                    <form action="<?php echo site_url('Detail/update/' . $edit['id_detailstok']) ?>" method="post">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" name="id_detailstok" disabled
                                value="<?php echo $edit['id_detailstok'] ?>">
                            <input type="text" class="form-control" name="id_detailstok" hidden
                                value="<?php echo $edit['id_detailstok'] ?>">
                        </div>
                        <div class="mb-3">
