        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-secondary navbar-dark">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <a href="<?php echo site_url('Detail') ?>" class="nav-item nav-link active"><i class="fa fa-keyboard me-2"></i>Detail Stok</a>
