...
<head>
    <meta charset="utf-8">
    <title>Tambah Informasi Detail Darah</title>
        ...
        <div class="content">
            ...
            <div class="container-fluid pt-4 px-4">
                <div class="bg-secondary rounded h-100 p-4">
                    <h6 class="mb-4">Tambah Detail Darah</h6>
                    <form class="" action="<?php echo site_url('Informasi/save') ?>" method="post">
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <select name="goldar" class="form-control" id="">
                        ...
                        <div class="mb-3">
                            ...
                            <select name="rhesus" class="form-control" id="">
                        ...
                        <a href="<?php echo site_url('Informasi') ?>"><button type="button" name="button" class="btn btn-primary">Batal</button></a>
                    </form>
                </div>
            </div>
            <!-- Recent Sales End -->
