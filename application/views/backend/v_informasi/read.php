            ...
            <div class="container-fluid pt-4 px-4">
                <div class="bg-secondary text-center rounded p-4">
                    <div class="d-flex align-items-center justify-content-between mb-4">
                        <h6 class="mb-0">Daftar Stok Darah</h6>
                    </div>
                    <div class="d-flex align-items-center justify-content-between mb-4">
                        <a href="<?php echo site_url('Informasi/create') ?>">
                        ...
                        <a href="<?php echo site_url('Informasi/export') ?>">
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="<?php echo site_url('Informasi/edit/' . $row['id_darah']) ?>" title="tombol utk merubah data">Ubah</a> |
                                            <!--memanggil aksi delete-->
                                            <a href="<?php echo site_url('Informasi/delete/' . $row['id_darah']) ?>" onclick="javascript: return confirm('Yakin Mau dihapus <?php echo $row['darah']; ?>')">Hapus</a>
                                        </td>
                                    </tr>
                                <?php
                                    $no++;
