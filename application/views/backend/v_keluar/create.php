...
<head>
  <meta charset="utf-8">
  <title>Tambah Data Darah Keluar</title>
    ...
    <div class="sidebar pe-4 pb-3">
      <nav class="navbar bg-secondary navbar-dark">
        ...
        <div class="navbar-nav w-100">
          ...
          <a href="<?php echo site_url('Stok') ?>" class="nav-item nav-link "><i class="fa fa-laptop me-2"></i>Stok
            Darah</a>
          <a href="<?php echo site_url('Informasi') ?>" class="nav-item nav-link"><i class="fa fa-th me-2"></i>Detail
            Darah</a>
          <a href="<?php echo site_url('Detail') ?>" class="nav-item nav-link"><i class="fa fa-keyboard me-2"></i>Detail
            Stok Darah</a>
          <a href="<?php echo site_url('Masuk') ?>" class="nav-item nav-link"><i class="fa fa-table me-2"></i>Data
            Masuk</a>
          <a href="<?php echo site_url('Keluar') ?>" class="nav-item nav-link active"><i class="fa fa-chart-bar me-2"></i>Data Keluar</a>
          <a href="<?php echo site_url('Admin') ?>" class="nav-item nav-link"><i class="fa fa-chart-bar me-2"></i>Kelola
            Admin</a>
    ...
    <div class="content">
      ...
      <div class="container-fluid pt-4 px-4">
        <div class="bg-secondary rounded h-100 p-4">
          <h6 class="mb-4">Tambah Data Keluar</h6>
          <form class="" action="<?php echo site_url('keluar/save') ?>" method="post">
            <div class="mb-3">
              <label class="form-label">Darah</label>
              <select name="id_stok" class="form-control" required>
                <option value="">Pilih Darahnya</option>
                <?php
                foreach ($stok_darah->result_array() as $r) {
                ?>
            ...
            <a href="<?php echo site_url('Keluar') ?>"><button type="button" name="button" class="btn btn-primary">Batal</button></a>
          </form>
        </div>
      </div>
      <!-- Recent Sales End -->
