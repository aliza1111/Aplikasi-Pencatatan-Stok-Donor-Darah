...
<head>
    <meta charset="utf-8">
    <title>Edit Data Darah Keluar</title>
        ...
        <div class="content">
            ...
            <div class="container-fluid pt-4 px-4">
                <div class="bg-secondary rounded h-100 p-4">
                    <h6 class="mb-4">Edit Data Keluar</h6>
                    <form action="<?php echo site_url('Keluar/update/' . $edit['id_keluar']) ?>" method="post">
                        <div class="mb-3">
                            <label class="form-label">Id_Masuk</label>
                            <input type="text" class="form-control" name="id_keluar" disabled value="<?php echo $edit['id_keluar'] ?>">
                            <input type="hidden" name="id_keluar" value="<?php echo $edit['id_keluar'] ?>">
                        </div>
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control" name="qty" value="<?php echo $edit['qty'] ?>">
                        </div>
                        <div class="mb-3">
                            <label class="form-label">Penerima</label>
                            <input type="text" class="form-control" name="penerima" value="<?php echo $edit['penerima'] ?>">
                        </div>
                        <div class="d-flex">
                            <button type="submit" name="button" class="btn btn-success me-2">Perbarui</button>
                            <a href="<?php echo site_url('Keluar') ?>" class="btn btn-primary">Batal</a>
                        </div>
                    </form>
                </div>
            </div>
