            ...
            <div class="container-fluid pt-4 px-4">
                <div class="bg-secondary text-center rounded p-4">
                    <div class="d-flex align-items-center justify-content-between mb-4">
                        <h6 class="mb-0">Daftar Data Keluar</h6>
                    </div>
                    <div class="d-flex align-items-center justify-content-between mb-4">
                        <a href="<?php echo site_url('Keluar/create') ?>">
                        ...
                        <a href="<?php echo site_url('Keluar/export') ?>">
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="<?php echo site_url('Keluar/edit/' . $row['id_keluar']) ?>" title="tombol utk merubah data">Ubah</a> |
                                            <!--memanggil aksi delete-->
                                            <a href="<?php echo site_url('Keluar/delete/' . $row['id_keluar']) ?>" onclick="javascript: return confirm('Yakin Mau dihapus <?php echo $row['darah']; ?>')">Hapus</a>
                                        </td>
                                    </tr>
                                <?php
                                    $no++;
