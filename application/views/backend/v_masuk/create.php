...
<head>
    <meta charset="utf-8">
    <title>Tambah Data Darah Masuk</title>
        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-secondary navbar-dark">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <a href="<?php echo site_url('Masuk') ?>" class="nav-item nav-link active"><i
        ...
        <div class="content">
            ...
            <div class="container-fluid pt-4 px-4">
                <div class="bg-secondary rounded h-100 p-4">
                    <h6 class="mb-4">Tambah Data Masuk</h6>
                    <form class="" action="<?php echo site_url('Masuk/save') ?>" method="post">
                        <div class="mb-3">
                        ...
                        <a href="<?php echo site_url('Masuk') ?>"><button type="button" name="button" class="btn btn-primary">Batal</button></a>
                    </form>
                </div>
            </div>
            <!-- Recent Sales End -->
