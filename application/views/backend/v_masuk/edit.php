...
<head>
    <meta charset="utf-8">
    <title>Edit Data Darah Masuk</title>
        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-secondary navbar-dark">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <a href="<?php echo site_url('Masuk') ?>" class="nav-item nav-link active"><i class="fa fa-table me-2"></i>Data Masuk</a>
        ...
        <div class="content">
            ...
            <div class="container-fluid pt-4 px-4">
                <div class="bg-secondary rounded h-100 p-4">
                    <h6 class="mb-4">Edit Data Masuk</h6>
                    <form action="<?php echo site_url('Masuk/update/' . $edit['id_masuk']) ?>" method="post">
                        <div class="mb-3">
                            <label class="form-label">Id_Masuk</label>
                            <input type="text" class="form-control" name="id_masuk" disabled value="<?php echo $edit['id_masuk'] ?>">
                            <input type="hidden" name="id_masuk" value="<?php echo $edit['id_masuk'] ?>">
                        </div>
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" name="pendonor" value="<?php echo $edit['pendonor'] ?>">
                        </div>
                        <div class="d-flex">
                            <button type="submit" name="button" class="btn btn-success me-2">Perbarui</button>
                            <a href="<?php echo site_url('Stok') ?>" class="btn btn-primary">Batal</a>
                        </div>
                    </form>
                </div>
            </div>
