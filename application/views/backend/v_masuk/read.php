            ...
            <div class="container-fluid pt-4 px-4">
                <div class="bg-secondary text-center rounded p-4">
                    <div class="d-flex align-items-center justify-content-between mb-4">
                        <h6 class="mb-0">Daftar Data Masuk</h6>
                    </div>
                    <div class="d-flex align-items-center justify-content-between mb-4">
                        <a href="<?php echo site_url('Masuk/create') ?>">
                        ...
                        <a href="<?php echo site_url('Masuk/export') ?>">
                            ...
                            <tbody>
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td>
                                            <?php echo $row['pendonor'] ?>
                                        </td>
                                        <td>
                                            <!--memanggil halaman edit atau edit.php-->
                                            <a href="<?php echo site_url('Masuk/edit/' . $row['id_masuk']) ?>" title="tombol utk merubah data">Ubah</a> |
                                            <!--memanggil aksi delete-->
                                            <a href="<?php echo site_url('Masuk/delete/' . $row['id_masuk']) ?>" onclick="javascript: return confirm('Yakin Mau dihapus <?php echo $row['darah']; ?>')">Hapus</a>
                                        </td>
                                    </tr>
                                <?php
                                    $no++;
