        ...
        <div class="content">
            ...
            <div class="container-fluid pt-4 px-4">
                <div class="bg-secondary rounded h-100 p-4">
                    <h6 class="mb-4">Tambah Stok Darah</h6>
                    <form class="" action="<?php echo site_url('Stok/save') ?>" method="post">
                        <div class="mb-3">
                        ...
                        <a href="<?php echo site_url('Stok') ?>"><button type="button" name="button" class="btn btn-primary">Batal</button></a>
                    </form>
                </div>
            </div>
            <!-- Recent Sales End -->
