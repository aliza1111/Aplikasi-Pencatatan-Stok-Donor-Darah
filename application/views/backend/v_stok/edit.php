...
<body>
        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-secondary navbar-dark">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <a href="<?php echo site_url('Stok') ?>" class="nav-item nav-link active"><i
                    ...
                    <a href="<?php echo site_url('Admin') ?>" class="nav-item nav-link"><i
    ...
    <div class="bg-secondary rounded h-100 p-4">
        <h6 class="mb-4">Edit Stok Darah</h6>
        <form action="<?php echo site_url('Stok/update/' . $edit['id_stok']) ?>" method="post">
            <div class="mb-3">
                <label class="form-label">id_stok</label>
                <input type="text" class="form-control" name="id_stok" disabled value="<?php echo $edit['id_stok'] ?>">
                <input type="hidden" name="id_stok" value="<?php echo $edit['id_stok'] ?>">
            </div>
            <div class="mb-3">
                <label class="form-label">Darah</label>
                <input type="text" class="form-control" name="darah" value="<?php echo $edit['darah'] ?>">
            </div>
            <div class="mb-3">
                <label class="form-label">Stok</label>
                <input type="number" class="form-control" name="stok" value="<?php echo $edit['stok'] ?>">
            </div>
            <div class="mb-3">
