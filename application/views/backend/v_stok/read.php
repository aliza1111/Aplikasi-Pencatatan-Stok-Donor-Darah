        ...
        <div class="content">
            ...
            <div class="container-fluid pt-4 px-4">
                <div class="bg-secondary text-center rounded p-4">
                    ...
                    <div class="d-flex align-items-center justify-content-between mb-4">
                        <a href="<?php echo site_url('Stok/create') ?>">
                        ...
                        <a href="<?php echo site_url('Stok/export') ?>">
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="<?php echo site_url('Stok/edit/' . $row['id_stok']) ?>" title="tombol utk merubah data">Ubah</a> |
                                            <!--memanggil aksi delete-->
                                            <a href="<?php echo site_url('Stok/delete/' . $row['id_stok']) ?>" onclick="javascript: return confirm('Yakin Mau dihapus <?php echo $row['darah']; ?>')">Hapus</a>
                                        </td>
                                    </tr>
                                <?php
                                    $no++;
